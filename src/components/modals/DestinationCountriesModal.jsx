...
import styles from "../../styles/component_styles/modals/DestinationCountriesModal.module.css";

const DestinationCountriesModal = ({ show, onHide, data }) => {
  const [activeKey, setActiveKey] = useState(null);

  // Build mapping continent -> countries -> flights
  const countriesByContinent = data.reduce((acc, flight) => {
    if (!flight.arrivalAirportCountry || !flight.arrivalAirportContinent)
      return acc;

    const country = flight.arrivalAirportCountry;
    const continent = flight.arrivalAirportContinent;
    const code = flight.arrivalAirportCountryCode;
...
export default DestinationCountriesModal;
