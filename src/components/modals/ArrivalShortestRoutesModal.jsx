...
import styles from "../../styles/component_styles/modals/ArrivalShortestRoutesModal.module.css";
...
const ArrivalShortestRoutesModal = ({ show, onHide, data }) => {
...
export default ArrivalShortestRoutesModal;
