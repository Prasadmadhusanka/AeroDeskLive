...
import styles from "../../styles/component_styles/modals/ArrivalLongestRoutesModal.module.css";
...
const ArrivalLongestRoutesModal = ({ show, onHide, data }) => {
...
export default ArrivalLongestRoutesModal;
