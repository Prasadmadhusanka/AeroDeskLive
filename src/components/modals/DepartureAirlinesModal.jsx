...
import styles from "../../styles/component_styles/modals/DepartureAirlinesModal.module.css";

const DepartureAirlinesModal = ({ show, onHide, data }) => {
...
export default DepartureAirlinesModal;
